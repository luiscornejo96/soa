...
/*
 *  CalcularServiceStub java implementation
 */
public class CalcularServiceStub extends org.apache.axis2.client.Stub {
    ...
    //http://localhost:8080/axis2/services/CalcularService
     ...
     * Default Constructor
     */
    public CalcularServiceStub() throws org.apache.axis2.AxisFault {
        this("http://localhost:8080/axis2/services/CalcularService");
    }

    /**
     * Constructor taking the target endpoint
     */
    public CalcularServiceStub(java.lang.String targetEndpoint)
        throws org.apache.axis2.AxisFault {
    ...
    private void populateAxisService() throws org.apache.axis2.AxisFault {
        ...
        _service = new org.apache.axis2.description.AxisService(
                "CalcularService" + getUniqueSuffix());
        ...
        __operation.setName(new javax.xml.namespace.QName("http://nombre.com",
                "calcularOperation"));
     ...
     *
     * @see com.nombre.CalcularService#calcularOperation
    ...
    public com.nombre.ResponseLuisCornejoDocument calcularOperation(
        ...
        try {
            ...
            _operationClient.getOptions().setAction("http://nombre.com/nombre");
            ...
            java.lang.Object object = fromOM(_returnEnv.getBody()
                                                       .getFirstElement(),
                    com.nombre.ResponseLuisCornejoDocument.class);

            return (com.nombre.ResponseLuisCornejoDocument) object;
            ...
            if (faultElt != null) {
                if (faultExceptionNameMap.containsKey(
                            new org.apache.axis2.client.FaultMapKey(
                                faultElt.getQName(), "CalcularOperation"))) {
