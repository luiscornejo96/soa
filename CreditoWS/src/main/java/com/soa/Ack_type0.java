...
public class Ack_type0 implements org.apache.axis2.databinding.ADBBean {
        ...
        if (serializeType) {
            ...
            if ((namespacePrefix != null) &&
                ...
                writeAttribute("xsi",
                    ...
                    namespacePrefix + ":ack_type0", xmlWriter);
            } else {
                writeAttribute("xsi",
                    "http://www.w3.org/2001/XMLSchema-instance", "type",
                    "ack_type0", xmlWriter);
    ...
    public static class Factory {
         ...
         */
        public static Ack_type0 parse(javax.xml.stream.XMLStreamReader reader)
            throws java.lang.Exception {
            Ack_type0 object = new Ack_type0();
            ...
            try {
                ...
                if (reader.getAttributeValue(
                    ...
                    if (fullTypeName != null) {
                        ...
                        if (!"ack_type0".equals(type)) {
                            ...
                            return (Ack_type0) com.soa.ExtensionMapper.getTypeObject(nsUri,
                                type, reader);
                        }
                    }
                }
                ...
                if (reader.isStartElement() &&
                        new javax.xml.namespace.QName("http://soa.com", "code").equals(
                            reader.getName())) {
