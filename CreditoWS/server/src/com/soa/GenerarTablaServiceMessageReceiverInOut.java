        ...
        try {
            ...
            if ((op.getName() != null) &&
                ...
                if ("generarTablaOperation".equals(methodName)) {
                    com.soa.TablaAmortizacionResponse tablaAmortizacionResponse6 =
                        null;
                    com.soa.TablaAmortizacionResponse wrappedParam = (com.soa.TablaAmortizacionResponse) fromOM(msgContext.getEnvelope()
                                                                                                                          .getBody()
                                                                                                                          .getFirstElement(),
                            com.soa.TablaAmortizacionResponse.class);

                    tablaAmortizacionResponse6 = skel.generarTablaOperation(wrappedParam);

                    envelope = toEnvelope(getSOAPFactory(msgContext),
                            tablaAmortizacionResponse6, false,
